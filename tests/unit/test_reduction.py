...
These tests exercise the auto-AllReduce mechanism that triggers when reducing
over a sharded axis — functionality NOT covered by the unified test matrix.
Forward/VJP/JVP/vmap correctness for individual reduction ops is covered by
