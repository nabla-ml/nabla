...
class AddOneCustomOp(UnaryOperation):
    ...
    # Invoke Mojo kernel via MAX kernel library
...
# Test automatic sharding propagation
...
# Test automatic vectorization (vmap)
