...
def step_1f1b_fn(state, inputs, constants):
    ...
    return (grads, stash, w_idx, r_idx), (fwd_out_shifted, fwd_mask_shifted, bwd_out_shifted, bwd_mask_shifted)
...
step_1f1b = shard_map(
    ...
    in_specs=(
        ...
        (P('stage',None,None), P('stage',None), P('stage',None,None), P('stage',None)), 
...
y_pad = jnp.zeros((MICRO_BATCHES, STAGES, MICRO_BATCH_SIZE, DIM)).at[:, STAGES-1].set(y_data)
