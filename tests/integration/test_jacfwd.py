...
def test_vector_to_scalar_jacobian():
    ...
    print("\n=== FIRST DERIVATIVE (JACOBIAN) COMPARISON ===")
    jac_fn_nb = nb.jacfwd(func_nb)
    jac_fn_jax = jax.jacfwd(func_jax)
    ...
    print("\n=== SECOND DERIVATIVE (HESSIAN) COMPARISON ===")
    hess_fn_nb = nb.jacfwd(jac_fn_nb)
    hess_fn_jax = jax.jacfwd(jac_fn_jax)
    ...
    print("\n=== THIRD DERIVATIVE COMPARISON ===")
    third_fn_nb = nb.jacfwd(hess_fn_nb)
    third_fn_jax = jax.jacfwd(hess_fn_jax)
    ...
    print("\n=== FORTH DERIVATIVE COMPARISON ===")
    forth_fn_nb = nb.jacfwd(third_fn_nb)
    forth_fn_jax = jax.jacfwd(third_fn_jax)
