...
def test_mlp_training_with_benchmark():
    ...
    # Demonstrate benefits of functional approach
    print("\n=== Benefits of Functional Optimizer ===")
    print("✅ Pure functions - no hidden mutable state")
    print("✅ Compatible with vmap, vjp, jvp transformations")
    print("✅ Explicit state management")
    print("✅ JIT-compilation friendly")
    print("✅ Gradient checkpointing compatible")
    print("✅ Easy to parallelize across batches")
