...
| :--- | :--- | :--- |
| [`context.py`](context.py) | **Global State** & **Defaults** | **Classes**: None<br>**Functions**: `defaults`, `default_device`, `default_dtype`, `defaults_like`, `contextvar_context`<br>**Internals**: `_session`, `_default_device`, `_default_dtype` |
| [`pytree.py`](pytree.py) | **Structure Handling** | **Classes**: `PyTreeDef`<br>**Functions**: `tree_flatten`, `tree_unflatten`, `tree_leaves`, `tree_structure`, `tree_map`<br>**Tensor Helpers**: `traced`, `untraced`, `with_batch_dims`, `tensor_leaves`, `is_tensor`, `is_tensor_value` |
