...
def test_jax_static_behavior():
    ...
    for step in range(1, 4):
        param_jit, m_jit, v_jit = adam_update_regular_jit(param_jit, grad, m_jit, v_jit, step)
    ...
    for step in range(1, 4):
        param_static, m_static, v_static = adam_update_static_jit(param_static, grad, m_static, v_static, step)
