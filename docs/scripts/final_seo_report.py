...
def print_final_report():
    ...
    print("   Status: Partially fixed in template, but Sphinx base still adds duplicates")
    ...
    print("duplication problem that's easily fixable. Once resolved, your documentation")
